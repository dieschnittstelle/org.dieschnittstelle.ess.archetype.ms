 ...
 * CDI Containers verwendet und eindeutig identifiziert werden (siehe MIP:56-57).
 *
...
public class ${persistenceUnitName}EntityManagerProvider {
    ...
    /*
     * Die @Produces Annotation markiert das Attribut em als "Producer" (MIP:58)
     */
    @Produces
    /*
     * Hier wird die oben deklarierte Qualifier-Annotation verwendet (MIP:56-57), d.h. unter Angabe von
