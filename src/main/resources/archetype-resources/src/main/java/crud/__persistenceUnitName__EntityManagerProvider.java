 ...
 * CDI Containers verwendet und eindeutig identifiziert werden (siehe MIP:61-63).
 *
...
public class ${persistenceUnitName}EntityManagerProvider {
     ...
     * Laufzeit-Annotation, die als CDI Qualifier deklariert wird. (fuer Annotationen siehe BAS:51-62)
     */
    @Qualifier
    /* ? Wie nennt man die Annotationstypen @Retention und @Target? (siehe BAS:61-62) Weshalb? */
    ...
    /*
     * Die @Produces Annotation markiert das Attribut em als "Producer" (MIP:64)
     */
    @Produces
    /*
     * Hier wird die oben deklarierte Qualifier-Annotation verwendet (MIP:62-63), d.h. unter Angabe von
     ...
     * gestellt wird (siehe JPA:81 fuer das "Big Picture" von CDI+JPA sowie die Konfigurationsdatei
