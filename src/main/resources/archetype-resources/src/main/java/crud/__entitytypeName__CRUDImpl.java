 ...
 * CDI Bean
 *
 * ? welche Voraussetzung muss gegeben sein, damit diese Klasse als @ApplicationScoped deklariert werden kann? (siehe MIP:59)
 */
@ApplicationScoped
@Transactional
public class ${entitytypeName}CRUDImpl implements ${entitytypeName}CRUD {
    ...
    public List<${entitytypeName}Composite> readAll${entitytypeName}Composites() {
         ...
         * Formulierung von JPA QL Abfragen erforderlich? (siehe JPA:35-36)
         */
        return (List)em
    ...
    public ${entitytypeName}Composite create${entitytypeName}Composite(${entitytypeName}Composite instance) {
         ...
         * fuer eine gegebene Instanz von ${entitytypeName}Composite erfuellt sein? (siehe JPA:62+68)
         */
        em.persist(instance);
        return instance;
    }
