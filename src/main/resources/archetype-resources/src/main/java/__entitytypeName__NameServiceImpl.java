 ...
 * dem ServletContext von Ja*a EE Web Applikationen (siehe MIP:50-52).
 *
 ...
 * Abschluss / das Commit von Transaktionen wird durch den CDI Interzeptor-Mechanismus gehandhabt  (siehe MIP:59),
...
public class ${entitytypeName}NameServiceImpl implements ${entitytypeName}NameService {
     ...
     * ein Proxy-Objekt (siehe WSV:22ff sowie SUM. Fuer Dependency Injection allgemein siehe JRS:63).
     * Voraussetzung dafuer, dass die Injektion durchgefuehrt werden kann, ist die eindeutige
     * Ermittelbarkeit einer Implementierung (siehe MIP:55-57).
     *
