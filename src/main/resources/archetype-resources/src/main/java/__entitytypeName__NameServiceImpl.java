 ...
 * dem ServletContext von Ja*a EE Web Applikationen (siehe MIP:55-59).
 *
 ...
 * wird die dort ggf. erstellte Transaktion wieder verwendet (siehe JPA:69). Die Erstellung und der
 * Abschluss / das Commit von Transaktionen wird durch den CDI Interzeptor-Mechanismus gehandhabt  (siehe MIP:65),
